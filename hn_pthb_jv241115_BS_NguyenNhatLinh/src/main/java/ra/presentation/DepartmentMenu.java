...
//    public static void display(Scanner scanner, DepartmentDesign departmentService) throws SQLException, IOException {
//        while (true) {
//            System.out.println("\n**********************DEPARTMENT-MENU********************");
...
//            scanner.nextLine(); // Xử lý newline
...
//            System.out.print("Nhập trạng thái mới của phòng ban (true/false): ");
//            boolean newStatus = scanner.nextBoolean();
//
//            Department department = new Department(departmentId, newName, newStatus);
